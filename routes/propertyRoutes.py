...
def get_properties():
    ...
    return jsonify([{
        ...
        'propertyPostCode': p.propertyPostCode,
        'propertyStreet': p.propertyStreet,
        'propertyStreetNumber': p.propertyStreetNumber,
        'price': p.price,
...
def get_property(property_id):
    ...
    return jsonify({
        ...
        'propertyPostCode': property_obj.propertyPostCode,
        'propertyStreet': property_obj.propertyStreet,
        'propertyStreetNumber': property_obj.propertyStreetNumber,
